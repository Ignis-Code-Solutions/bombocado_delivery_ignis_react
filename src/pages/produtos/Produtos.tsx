import { ArrowRightIcon, ClockIcon, PackageIcon, SignOutIcon, TagIcon, WarningCircleIcon, } from '@phosphor-icons/react'
        ...
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-ink-soft sm:text-base">
              Encontre alimentos disponíveis na
              plataforma e descubra opções para comprar
              de forma mais acessível e consciente.
            </p>
          </div>
          ...
          <div className="w-full lg:max-w-sm">
            ...
            <input
              ...
              className="h-12 w-full rounded-button border border-outline bg-white px-4 text-sm outline-none transition placeholder:text-ink-muted focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
        </div>
              ...
              (_, index) => (
                ...
                >
                  ...
                  <div className="space-y-3 p-5">
                    ...
                    <div className="h-10 w-full animate-pulse rounded bg-neutral-light" />
                  </div>
                </div>
              ),
            )}
                    ...
                    >
                      <div className="relative w-32 shrink-0 overflow-hidden bg-neutral-light sm:h-48 sm:w-full">
                        {produto.imagem ? (
                          ...
                          <div className="flex h-full min-h-40 w-full items-center justify-center text-ink-muted sm:min-h-0">
                            <PackageIcon
                              size={42}
                              weight="duotone"
                            />
                        ...
                        {produto.categoria?.nome && (
                          <span className="absolute left-3 top-3 max-w-[calc(100%-1.5rem)] truncate rounded-full bg-white/95 px-3 py-1 text-xs font-bold text-primary shadow-sm">
                            {produto.categoria.nome}
                          </span>
                        )}
                      </div>
